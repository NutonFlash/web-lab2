                                ...
                                <table id="input-grid">
                                    ...
                                    <tr class="value-container">
                                        ...
                                        <td class="input-grid-value">
                                            <div id="x_err"></div>
                                            <input autocomplete="off" id="x-textinput" maxlength="9" name="yvalue"
                                    ...
                                    <tr class="value-container">
                                        ...
                                        <td class="r-radio-group">
                                            <div id="radio-container">
                                                <div id="r_err"></div>
                                                <label for="r-radio1">1</label> <input type="radio" class="r-radio" value="1" name="r-coordinate" id="r-radio1">
                                                <label for="r-radio2">1.5</label> <input type="radio" class="r-radio" value="1.5" name="r-coordinate" id="r-radio2">
                                                <label for="r-radio3">2</label> <input type="radio" class="r-radio" value="2" name="r-coordinate" id="r-radio3">
                                                <label for="r-radio4">2.5</label> <input type="radio" class="r-radio" value="2.5" name="r-coordinate" id="r-radio4">
                                                <label for="r-radio5">3</label> <input type="radio" class="r-radio" value="3" name="r-coordinate" id="r-radio5">
                                            </div>
                                        </td>
                                    </tr>
                                    <!--Buttons-->
                                    <tr>
                                        <td class="buttons-row" colspan="2">
                                            <div class="buttons">
                                                ...
                                                <input class="button" name="Reset" type="reset" value="Reset" id="reset">
                                            </div>
                                        </td>
                                    </tr>
